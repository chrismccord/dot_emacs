(custom-set-variables
 ...
 '(dabbrev-abbrev-skip-leading-regexp ":")
  ...
  '(package-selected-packages
     (quote
       (yafolding hideshow-org web-mode package-build shut-up epl git commander f dash s)))
